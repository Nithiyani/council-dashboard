...
const categoryData = [
  ...
  { name: 'tourism', value: 5, color: '#8B5CF6' },
  { name: 'ads', value: 5, color: '#8B5CF6' },
  { name: 'social work', value: 5, color: '#8B5CF6' },
];
  ...
  return (
    <div className="space-y-4 sm:space-y-6 p-4 sm:p-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-6">
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">tourism</CardTitle>
            <Image className="h-4 w-4 text-emerald-600" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">22</div>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">social work</CardTitle>
            <Image className="h-4 w-4 text-emerald-600" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">22</div>
            ...
            <div className="h-64 sm:h-80">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={dashboardData} margin={{ top: 10, right: 10, left: 0, bottom: 20 }}>
                  ...
                  <Bar dataKey="tourism" fill="#06B6D4" name="tourism" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
      ...
      <Card className="hover:shadow-lg transition-shadow duration-300">
        ...
        <CardContent>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            ...
            <Button variant="outline" className="h-20 flex flex-col items-center space-y-2">
              <Settings className="w-6 h-6" />
              <span className="text-xs">tourism</span>
            </Button>
            <Button variant="outline" className="h-20 flex flex-col items-center space-y-2">
              <Settings className="w-6 h-6" />
            ...
            <Button variant="outline" className="h-20 flex flex-col items-center space-y-2">
              <Settings className="w-6 h-6" />
              <span className="text-xs">social work</span>
            </Button>
          </div>
        </CardContent>
      </Card>
